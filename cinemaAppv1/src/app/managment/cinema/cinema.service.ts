...
export class CinemaService {
    ...
    createItem(item):Observable<any>{
        ...
        console.log(item);
        return this._http.post(this.API_URL + 'users/createCinema/', JSON.stringify(item),{headers});
    }
    ...
    getList():Observable<Cinema[]>{
        return this._http.get<Cinema[]>(this.API_URL + 'cinema/');
    }
    // Handle API errors
    ...
    updateItem(item:Cinema) :Observable<any>{
        const headers = new HttpHeaders().set('Content-Type','application/json');
